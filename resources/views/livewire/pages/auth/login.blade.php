...
<div class="mx-auto w-full max-w-md">
    <div class="rounded-[28px] border border-slate-100 bg-white/90 p-8 shadow-[0_30px_80px_rgba(15,23,42,0.15)] backdrop-blur dark:border-slate-800 dark:bg-slate-900/80">
        <div class="flex items-center justify-between gap-4">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">Masuk sekarang</p>
                <h1 class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">{{ config('app.name') }}</h1>
            </div>
